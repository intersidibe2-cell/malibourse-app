...
import { ArrowLeft, FileText, IdCard, Stamp, Certificate, CalendarClock, Passport, AlertTriangle, Construction } from "lucide-react";
...
const futursServices = [
  ...
  { icon: Certificate, title: "Certificats d'état civil", desc: "Demande de certificats de mariage, décès, naissance", color: "from-purple-400 to-purple-500" },
