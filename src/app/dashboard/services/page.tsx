...
import { Construction, FileText, IdCard, Stamp, Certificate, CalendarClock, Passport, AlertTriangle, Lightbulb } from "lucide-react";
...
const futursServices = [
  ...
  { icon: Certificate, title: "Certificats d'état civil", desc: "Mariage, décès, naissance — demande en ligne", color: "from-purple-400 to-purple-500", statut: "planification" },
